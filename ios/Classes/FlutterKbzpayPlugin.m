...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  if ([@"startPay" isEqualToString:call.method]) {
      ...
      NSString *merchantCode = call.arguments[@"merchantCode"];
      NSString *signKey = call.arguments[@"appKey"];
      NSString *urlScheme = call.arguments[@"urlScheme"];
      NSNumber *data = [self startPay:appId :merchantCode :prepayId :signKey :urlScheme];
      result((data));
